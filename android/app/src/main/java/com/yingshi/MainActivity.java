...
public class MainActivity extends Activity implements ATSplashExListener {
            ...
            if (splashAd.isAdReady()) {
                mHandler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        // splashAd.show(MainActivity.this, container, "f628c7999265cd");
                    }
                }, 10);
    ...
    public void jumpToMainActivity() {
        ...
        if (!hasHandleJump) {
            ...
            // // Toast.makeText(this, "start your AppActivity.",
            // Toast.LENGTH_SHORT).show();
