...
import {
  defaultPTRBackgroundColor,
  pullAnimatedBackgroundColor,
  PullToRefreshProps,
} from './PullToRefreshProps';
...
type BaseComponentProps = PullToRefreshProps &
  PullToRefreshViewState &
  PullToRefreshViewHandler;
...
export const PullToRefreshView: ComponentClass<PullToRefreshProps> = compose<
  BaseComponentProps,
  PullToRefreshProps
>(
  ...
  withHandlers<
    PullToRefreshProps & PullToRefreshViewState,
    PullToRefreshViewHandler
  >(() => {
    ...
    return {
      ...
      onMomentumScrollEnd:
        ({isRefreshing, scrollY, refreshHeight}) =>
        (event: NativeSyntheticEvent<NativeScrollEvent>) => {
