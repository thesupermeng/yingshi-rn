        ...
        <ScreenContainer>
            <View style={{ gap: spacing.m }}>
                ...
                <NotificationModal onConfirm={toggleVersionDialog} isVisible={isVersionDialogOpen}
                    title='检查更新'
                    subtitle1='当前已是最新版本1.1'
                    confirmationText='我知道了'
                />
                <ConfirmationModal onConfirm={() => {
                    dispatch(clearStorageMemory());
                    toggleClearDialog();
                }} onCancel={toggleClearDialog} isVisible={isClearDialogOpen}
                    title='空间清理'
                ...
                <View>
                    ...
                    <ShowMoreButton text='检查更新' onPress={toggleVersionDialog}
                        rightIcon={<View style={styles.icon}>
                            <Text style={{ ...textVariants.small, paddingBottom: 3, color: colors.muted }}>当前版本1.1</Text>
