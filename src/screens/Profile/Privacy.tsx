  ...
  return (
    <ScreenContainer>
      <View style={{gap: spacing.m}}>
        <TitleWithBackButtonHeader title="隐私协议" />
        ...
        <ScrollView style={{marginBottom:100}}  showsVerticalScrollIndicator={false}>
          ...
          影视TV隐私协议
             ...
             <Text style={{...textVariants.body, marginTop: 20, marginBottom: 10}}>一、引言</Text>
          <Text style={textVariants.small}>
            ...
            您需理解，只有在您确认并同意变更后的《影视TV隐私协议》，我们才会依据变更后的隐私协议收集、使用、处理和存储您的个人信息；您有权拒绝同意变更后的隐私协议，但请您知悉，一旦您拒绝同意变更后的隐私协议，可能导致您不能或不能继续完整使用影视TV的相关服务和功能，或者无法达到我们拟达到的服务效果。
             ...
             <Text style={{...textVariants.body, marginTop: 20, marginBottom: 10}}>
            二、名词解释
            {'\n'}
          ...
          <Text style={{...textVariants.small}}>
            ...
            服务器日志：通常情况下，我们的服务器会自动记录您在访问网站时所发出的网页请求。这些“服务器日志”通常包括您的网络请求、互联网协议地址、浏览器类型、浏览器语言、请求的日期和时间及可以唯一识别您的浏览器的一个或多个Cookie。
             ...
             <Text style={{...textVariants.body, marginTop: 20, marginBottom: 10}}>三、我们如何收集和使用您的个人信息</Text>
          <Text style={{...textVariants.small}}>
          1. 影视TV依据法律法规以及遵循正当、合法、必要的原则而收集和使用您在使用服务过程中主动提供或由于产品和/或服务需要而产生的个人信息。如果我们欲将您的个人信息用于本隐私协议未载明的其它用途，或基于特定目的将收集而来的信息用于其他目的，我们会及时以合理的方式向您告知，并在使用前再次征得您的同意。
...
{'\n'}  4.4 客户服务
当您向影视TV发起投诉、申诉或进行咨询时，为了您的账号与系统安全，我们可能需要您先行提供账号信息，并与您之前的个人信息相匹配以验证您的用户身份。同时，为了方便与您联系或帮助您解决问题，我们可能还需要您提供以下个人敏感信息：姓名、手机号码、电子邮件及其他联系方式、所在城市/地区信息。在您需要重置青少年模式的密码时，我们还需要您上传您的手持身份证照片信息进行人工的申诉。 另外，我们还会收集您与我们的沟通信息（包括文字/图片/音视频/通话记录形式）、与您的需求相关联的其他必要信息。我们收集这些信息是为了调查事实与帮助您解决问题，如您拒绝提供上述信息，我们可能无法向您及时反馈投诉、申诉或咨询结果。
{'\n'}  4.5 上传、下载视频或图片
...
{'\n'}  4.7 微博分享和投稿发布
当您使用iOS设备登录我们的产品并在使用微博分享和投稿发布功能时，我们将访问您的位置权限，并收集您提供的基于使用微博分享和投稿发布后向我们上传的位置信息。同时，您也可以随时通过您的设备系统开启/取消该权限。iOS端影视TV APP的位置权限可以通过系统关闭，路径为：“设置->影视TV->位置”。您开启该权限即视为您授权我们可以访问、获取、收集、使用您的该等个人信息；当您取消该授权后，我们将不再收集该信息，也无法再为您提供上述与之对应的服务；但除非您依照法律的规定删除了您的个人信息，否则您的取消行为不会影响我们基于您之前的授权进行的对您个人信息的处理、存储。当您更新APP版本后，未经您的明确同意，我们不会更改您之前设置的权限状态。
...
{'\n'}  h) 有权机关的要求、法律法规等规定的其他情形。
             ...
             <Text style={{...textVariants.body, marginTop: 20, marginBottom: 10}}>四、我们如何共享、转让、公开披露您的个人信息</Text>
          <Text style={{...textVariants.small}}>
          1. 共享
...
{'\n'}4.7 法律法规等规定的其他情形。
             ...
             <Text style={{...textVariants.body, marginTop: 20, marginBottom: 10}}>五、关于使用Cookie和同类技术</Text>
          <Text style={{...textVariants.small}}>
          ...
          {'\n'}2. 如果您拒绝我们使用Cookie及同类技术收集和使用您的相关信息，您可在浏览器具备该功能的前提下，通过您的浏览器的设置以管理、（部分/全部）拒绝Cookie与/或同类技术；或删除已经储存在您的计算机、移动设备或其他装置内的Cookie与/或同类技术，从而实现我们无法全部或部分追踪您的个人信息。您如需详细了解如何更改浏览器设置，请具体查看您使用的浏览器的相关设置页面。您理解并知悉：我们的某些产品/服务只能通过使用Cookie或同类技术才可得到实现，如您拒绝使用或删除的，您可能将无法正常使用我们的相关产品与/或服务或无法通过我们的产品与/或服务获得最佳的服务体验，同时也可能会对您的信息保护和账号安全性造成一定的影响。
             ...
             <Text style={{...textVariants.body, marginTop: 20, marginBottom: 10}}>六、我们对您个人信息的存储与保护</Text>
          <Text style={{...textVariants.small}}>
          1. 信息存储
          ...
          {'\n'}2.3 为防止安全事故的发生，我们成立了专门的数据安全部门并制定了妥善的预警机制和应急预案。一旦发生个人信息安全事件，我们将按照法律法规的要求，及时向您告知：安全事件的基本情况和可能的影响、我们已采取或将要采取的处置措施、您可自主防范和降低风险的建议和对您的补救措施，并立即启动应急预案，力求将损失最小化。我们将及时将事件相关情况以电话、推送通知等方式告知您。
             ...
             <Text style={{...textVariants.body, marginTop: 20, marginBottom: 10}}>七、您管理个人信息的权利</Text>
          <Text style={{...textVariants.small}}>
...
{'\n'}2.1 对于您的部分个人信息，我们在产品的相关功能页面为您提供了操作设置，您可以直接进行更正/修改，例如：“头像/昵称/性别/出生年月/个人签名”在影视TViOS客户端中的更正/修改路径为：点击头像-编辑资料。
...
如前文所述，我们提供的产品和服务的部分功能需要获得您使用设备的相关权限（包括：相机、麦克风、存储等，具体以本隐私协议第四条为准）。您可以在授权后随时撤回（或停止）对该权限的继续授权。当您更新App版本后，未经您的明确同意，我们不会更改您之前设置的权限状态。例如您可以通过移动设备中的“设置-隐私-照片”来关闭您对手机相册的授权。您也可以通过注销账号的方式，永久撤回我们继续收集您个人信息的全部授权。您需理解，当您撤回授权后，我们无法继续为您提供撤回授权所对应的特定功能和/或服务。但您撤回授权的决定，不会影响此前基于您的授权而开展的个人信息处理
             ...
             <Text style={{...textVariants.body, marginTop: 20, marginBottom: 10}}>八、我们对未成年人的保护</Text>
          <Text style={{...textVariants.small}}>
         ...
         {'\n'}2. 若您是未成年人的监护人，当您对您所监护的未成年人的个人信息有相关疑问时，您可以通过本隐私协议第十一条“联系我们”中公示的联系方式与我们沟通解决。如果我们发现在未事先获得可证实的监护人同意的情况下收集了未成年人的个人信息，则会尽快删除相关数据。
             ...
             <Text style={{...textVariants.body, marginTop: 20, marginBottom: 10}}>九、我们对去世用户的个人信息保护</Text>
          <Text style={{...textVariants.small}}>
          1. 影视TV将从2021年11月1日起，根据《个人信息保护法》的相关规定升级死者个人信息保护制度。影视TV用户（仅限自然人）去世后，其近亲属为了自身的合法、正当利益，可以通过本隐私协议第十一条“联系我们”中公示的联系方式，对去世用户的相关个人信息行使查阅、复制、更正、删除等权利，但是去世用户生前另有安排的除外。
          {'\n'}2. 您理解并确认，为了充分保护去世用户的个人信息权益，申请行使本条权利的去世用户近亲属需要根据影视TV的指定流程或客服提示，提交去世用户的身份证明文件、死亡证明文件、申请人的身份证明文件、申请人与去世用户的亲属关系证明文件，并提供申请行使的权利种类、目的。更多关于去世用户的个人信息保护流程、条件等事项请详见《帮助中心》。
          </Text>

             <Text style={{...textVariants.body, marginTop: 20, marginBottom: 10}}>十、联系我们</Text>
          <Text style={{...textVariants.small}}>
          1. 如您对本《影视TV隐私协议》的内容或使用我们的服务时遇到的与隐私保护相关的事宜有任何疑问或进行咨询或投诉时，您均可以通过如下任一方式与我们取得联系：
          ...
          {'\n'}2.7 法律法规等规定的其他情形。
             ...
             <Text style={{...textVariants.body, marginTop: 20, marginBottom: 10}}>十一、本政策如何更新</Text>
          <Text style={{...textVariants.small}}>
          ...
          {'\n'}2.6 个人信息安全影响评估报告表明存在高风险时。
             ...
             <Text style={{...textVariants.body, marginTop: 20, marginBottom: 10}}>十二、争议解决</Text>
          <Text style={{...textVariants.small}}>
