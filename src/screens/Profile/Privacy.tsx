                ...
                <Text style={textVariants.body}>
                    {
                       ...
                       `十二、争议解决\n\n` +
                       `一、引言\n\n` +
                       `1. 本《萤视频隐私协议》（以下称“本隐私协议”）适用于萤视频的全部产品和服务，包括iOS端应用程序、安卓端应用程序、网页端等全部终端客户端。\n` +
                       `2. 请您在使用萤视频各项产品和/或服务前，仔细阅读并充分理解本隐私协议的全部内容。一旦您使用或继续使用萤视频的产品/服务，即表示您同意我们按照本隐私协议使用和处理您的相关信息。\n` +
                       `3. 我们可能会不时依据法律法规或业务调整对本隐私协议进行修订。当本隐私协议发生变更后，我们会在版本更新后通过在显著位置提示或推送通知、消息等形式向您展示变更后的内容。\n` +
                       `4. 您需理解，只有在您确认并同意变更后的《萤视频隐私协议》，我们才会依据变更后的隐私协议收集、使用、处理和存储您的个人信息；您有权拒绝同意变更后的隐私协议，但请您知悉，一旦您拒绝同意变更后的隐私协议，可能导致您不能或不能继续完整使用萤视频的相关服务和功能，或者无法达到我们拟达到的服务效果。\n\n` +
                       `二、名词解释\n\n` +
                       ...
                       `8. 账号：当您注册账号并向我们提供一些个人信息，您就可以更好的使用我们的服务。当您访问萤视频时，系统会利用这些账号信息对您进行身份验证，以防止未经授权的人员访问您的账号。\n` +
                       ...
                       `三、我们如何收集和使用您的个人信息\n\n` +
                       `1. 萤视频依据法律法规以及遵循正当、合法、必要的原则而收集和使用您在使用服务过程中主动提供或由于产品和/或服务需要而产生的个人信息。如果我们欲将您的个人信息用于本隐私协议未载明的其它用途，或基于特定目的将收集而来的信息用于其他目的，我们会及时以合理的方式向您告知，并在使用前再次征得您的同意。\n` +
                       ...
                       `4.1 账号注册\n` +
                       `（1）您注册并登录萤视频账号时，需要按照我们的指引完成一系列注册程序，在此过程中，您需要向我们提供以下信息：账号昵称、手机号码（个人敏感信息，用于接受验证码匹配个人身份）。您只有提供真实准确的上述信息，才能成功注册萤视频账号并使用产品和/或服务的核心功能。如果您选择不提供上述为实现萤视频核心产品功能的必备信息，或将导致我们无法为您提供该核心产品功能。\n` +
                       ...
                       `（2）当您使用安卓设备登录我们的产品并使用视频展示和播放时，您可以随时通过使用我们的产品与/或服务的相关功能设置页面开启/取消移动网络信息权限。萤视频客户端的移动网络信息访问权限设置路径为：“设置—隐私设置-允许萤视频查看电话信息”。您开启该权限即视为您授权我们可以访问、获取、收集、使用您的该等个人信息；但当您取消该授权后，我们将不再收集该信息，也无法再为您提供上述与之对应的服务；但除非您依照法律的规定删除了您的个人信息，否则您的取消行为不会影响我们基于您之前的授权进行的您个人信息的处理、存储。当您更新APP版本后，未经您的明确同意，我们不会更改您之前设置的权限状态。\n` +
                       `（3）请您理解，您只有提供上述信息才能使用萤视频产品和/或服务的核心功能，如果您选择不提供上述为实现萤视频核心产品功能的必备信息，或将导致我们无法为您提供该核心产品功能。\n` +
                       `4.4 客户服务\n` +
                       `当您向萤视频发起投诉、申诉或进行咨询时，为了您的账号与系统安全，我们可能需要您先行提供账号信息，并与您之前的个人信息相匹配以验证您的用户身份。同时，为了方便与您联系或帮助您解决问题，我们可能还需要您提供以下个人敏感信息：姓名、手机号码、电子邮件及其他联系方式、所在城市/地区信息。在您需要重置青少年模式的密码时，我们还需要您上传您的手持身份证照片信息进行人工的申诉。 另外，我们还会收集您与我们的沟通信息（包括文字/图片/音视频/通话记录形式）、与您的需求相关联的其他必要信息。我们收集这些信息是为了调查事实与帮助您解决问题，如您拒绝提供上述信息，我们可能无法向您及时反馈投诉、申诉或咨询结果。\n` +
                       `4.5 上传、下载视频或图片\n` +
                       `当您使用移动设备登录我们的产品并使用视频投稿、视频缓存、截屏、动态壁纸、主题模板等功能进行视频或图片的上传、下载操作时，我们需要获取您设备的存储权限，并收集您主动提供的视频、图片信息。如您拒绝提供该权限和内容，仅会使您无法使用该功能，但并不影响您正常使用产品与/或服务的其他功能。同时，您也可以随时通过您的设备系统或使用我们的产品与/或服务的相关功能设置页面开启/取消该权限。萤视频客户端的存储权限设置路径为：“设置—隐私设置—允许萤视频使用文件存储和访问功能”。您开启该权限即视为您授权我们可以访问、获取、收集、使用您的该等个人信息；但当您取消该授权后，我们将不再收集该信息，也无法再为您提供上述与之对应的服务；但除非您依照法律的规定删除了您的个人信息，否则您的取消行为不会影响我们基于您之前的授权进行的您个人信息的处理、存储。当您更新APP版本后，未经您的明确同意，我们不会更改您之前设置的权限状态。\n` +
                       `4.6 视频拍摄\n` +
                       `（1）当您使用设备相机拍摄视频时，我们将访问您的设备相机相关权限，并收集您提供的基于拍摄视频后向我们上传的视频信息。如您拒绝提供该权限和内容的，仅会使您无法使用该功能，但并不影响您正常使用产品与/或服务的其他功能。同时，您也可以随时通过您的设备系统或使用我们的产品与/或服务的相关功能设置页面开启/取消该权限。萤视频客户端的相机权限设置路径为：“设置—隐私设置—允许萤视频使用相机功能”。\n` +
                       `（2）当您使用设备相机拍摄视频时，我们还将访问您的设备录音（麦克风）相关权限，我们需要收集您的语音信息、语音交互信息（个人信息）。如您拒绝提供该权限和内容的，仅会使您无法使用该功能，但并不影响您正常使用产品与/或服务的其他功能。同时，您也可以随时通过您的设备系统或使用我们的产品与/或服务的相关功能设置页面开启/取消该权限。萤视频客户端的麦克风权限设置路径为：“设置—隐私设置—允许萤视频使用麦克风功能”。当您更新APP版本后，未经您的明确同意，我们不会更改您之前设置的权限状态。您开启该权限即视为您授权我们可以访问、获取、收集、使用您的该等个人信息；当您取消该授权后，我们将不再收集该信息，也无法再为您提供上述与之对应的服务；但除非您依照法律的规定删除了您的个人信息，否则您的取消行为不会影响我们基于您之前的授权进行的您个人信息的处理、存储。\n` +
                       `4.7 微博分享和投稿发布\n` +
                       `当您使用iOS设备登录我们的产品并在使用微博分享和投稿发布功能时，我们将访问您的位置权限，并收集您提供的基于使用微博分享和投稿发布后向我们上传的位置信息。同时，您也可以随时通过您的设备系统开启/取消该权限。iOS端萤视频 APP的位置权限可以通过系统关闭，路径为：“设置->萤视频->位置”。您开启该权限即视为您授权我们可以访问、获取、收集、使用您的该等个人信息；当您取消该授权后，我们将不再收集该信息，也无法再为您提供上述与之对应的服务；但除非您依照法律的规定删除了您的个人信息，否则您的取消行为不会影响我们基于您之前的授权进行的对您个人信息的处理、存储。当您更新APP版本后，未经您的明确同意，我们不会更改您之前设置的权限状态。\n` +
                       `4.8 定向推荐、维护/改进我们的产品与/或服务之必需\n` +
                       `（1）我们会基于收集的信息，对您的偏好、习惯等作特征分析和用户画像，以便为您提供更适合的定制化服务，例如向您展现或推荐相关程度更高（而非普遍推送）的搜索结果、视频内容、信息流或者广告/推广信息结果。为此，我们需要收集（包括在后台状态下收集）您的信息，包括您的设备信息（硬件型号、设备MAC地址、IMEI、IDFA、IMSI、必要的软件列表）、浏览器型号、日志信息、浏览记录、点赞/分享/评论/互动的对象、搜索的字词、年龄、性别。同时，为保障您接收信息的自主性，当您对我们推送的个性化内容不感兴趣或希望减少某些信息推荐时，您可以在萤视频客户端内通过长按视频并选择“不感兴趣”，进行精准屏蔽。当您更新APP版本后，未经您的明确同意，我们不会更改您之前设置的权限状态。\n` +
                       ...
                       `2.1 对于您的部分个人信息，我们在产品的相关功能页面为您提供了操作设置，您可以直接进行更正/修改，例如：“头像/昵称/性别/出生年月/个人签名”在萤视频iOS客户端中的更正/修改路径为：点击头像-编辑资料。\n` +
                       ...
                       `九、我们对去世用户的个人信息保护\n\n` +
                       `1. 萤视频将从2021年11月1日起，根据《个人信息保护法》的相关规定升级死者个人信息保护制度。萤视频用户（仅限自然人）去世后，其近亲属为了自身的合法、正当利益，可以通过本隐私协议第十一条“联系我们”中公示的联系方式，对去世用户的相关个人信息行使查阅、复制、更正、删除等权利，但是去世用户生前另有安排的除外。\n` +
                       `2. 您理解并确认，为了充分保护去世用户的个人信息权益，申请行使本条权利的去世用户近亲属需要根据萤视频的指定流程或客服提示，提交去世用户的身份证明文件、死亡证明文件、申请人的身份证明文件、申请人与去世用户的亲属关系证明文件，并提供申请行使的权利种类、目的。更多关于去世用户的个人信息保护流程、条件等事项请详见《帮助中心》。\n\n` +
                       `十、联系我们\n\n` +
                       `1. 如您对本《萤视频隐私协议》的内容或使用我们的服务时遇到的与隐私保护相关的事宜有任何疑问或进行咨询或投诉时，您均可以通过如下任一方式与我们取得联系：\n` +
                       `1.1 您可在我们的产品功能页面的“设置”中找到“问题与反馈”在线提交反馈意见；\n` +
                       `1.2 您可以向我们开通的yingshipin.contactus@gmail.com客服邮箱发送邮件与我们联系；\n` +
