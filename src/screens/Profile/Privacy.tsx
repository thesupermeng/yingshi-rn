      ...
      <View style={{ gap: spacing.m }}>
        ...
        <Text style={textVariants.body}>
          {`《影视TV隐私协议》目录\n` +
            ...
            `十二、争议解决\n\n` +
            `一、引言\n\n` +
            `1. 本《影视TV隐私协议》（以下称“本隐私协议”）适用于影视TV的全部产品和服务，包括iOS端应用程序、安卓端应用程序、网页端等全部终端客户端。\n` +
            `2. 请您在使用影视TV各项产品和/或服务前，仔细阅读并充分理解本隐私协议的全部内容。一旦您使用或继续使用影视TV的产品/服务，即表示您同意我们按照本隐私协议使用和处理您的相关信息。\n` +
            `3. 我们可能会不时依据法律法规或业务调整对本隐私协议进行修订。当本隐私协议发生变更后，我们会在版本更新后通过在显著位置提示或推送通知、消息等形式向您展示变更后的内容。\n` +
            `4. 您需理解，只有在您确认并同意变更后的《影视TV隐私协议》，我们才会依据变更后的隐私协议收集、使用、处理和存储您的个人信息；您有权拒绝同意变更后的隐私协议，但请您知悉，一旦您拒绝同意变更后的隐私协议，可能导致您不能或不能继续完整使用影视TV的相关服务和功能，或者无法达到我们拟达到的服务效果。\n\n` +
            `二、名词解释\n\n` +
            ...
            `8. 账号：当您注册账号并向我们提供一些个人信息，您就可以更好的使用我们的服务。当您访问影视TV时，系统会利用这些账号信息对您进行身份验证，以防止未经授权的人员访问您的账号。\n` +
