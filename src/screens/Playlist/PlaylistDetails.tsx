...
function PlaylistDetail({ navigation }: RootStackScreenProps<'PlaylistDetail'>) {
  ...
  // ========== for analytics - start ==========
  const { playlistTopicsViewsAnalytics, playlistTopicsClickAnalytics } = useAnalytics();
      ...
      <ScreenContainer>
        ...
        {playlist && (
          <View style={{ gap: spacing.s, paddingBottom: 50 }}>
            ...
            <VodWithDescriptionList vodList={playlist.vod_list} onClickCatalogVideo={onClickCatalogVideo} />
          </View>
        )}
      </ScreenContainer>
    </>
