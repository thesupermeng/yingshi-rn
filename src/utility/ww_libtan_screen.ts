...
export const YingshiDarkTheme: wwPenaltyRegister = {
  dark: true,
  colors: {
...
export const YingshiLightTheme: wwPenaltyRegister = {
  ...DefaultTheme,
  dark: false,
  colors: {
...
declare module '@react-navigation/native' {
  export function useTheme(): wwPenaltyRegister;
}
