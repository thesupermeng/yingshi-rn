...
export const YingshiDarkTheme: yys_PaginationLibhermes = {
  dark: true,
  colors: {
...
export const YingshiLightTheme: yys_PaginationLibhermes = {
  ...DefaultTheme,
  dark: false,
  colors: {
...
declare module '@react-navigation/native' {
  export function useTheme(): yys_PaginationLibhermes;
}
