...
export const APPSFLYER_APPID = Platform.OS === 'android' ? 'com.yingshipin' : '';
...
export const INVITE_DOMAIN = 'https://dasdui.site/invite.html?invite=';
...
export const IS_YINGSHIPING = APP_NAME_CONST === '萤视频';
