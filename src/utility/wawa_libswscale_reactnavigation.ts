...
export const YingshiDarkTheme: wawaRoundEact = {
  dark: true,
  colors: {
...
export const YingshiLightTheme: wawaRoundEact = {
  ...DefaultTheme,
  dark: false,
  colors: {
...
declare module '@react-navigation/native' {
  export function useTheme(): wawaRoundEact;
}
