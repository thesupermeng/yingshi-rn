...
export const YingshiDarkTheme: ttAssistHeart = {
  dark: true,
  colors: {
...
export const YingshiLightTheme: ttAssistHeart = {
  ...DefaultTheme,
  dark: false,
  colors: {
...
declare module '@react-navigation/native' {
  export function useTheme(): ttAssistHeart;
}
