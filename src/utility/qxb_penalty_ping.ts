...
export const YingshiDarkTheme: DMegaphoneUpload = {
  dark: true,
  colors: {
...
export const YingshiLightTheme: DMegaphoneUpload = {
  ...DefaultTheme,
  dark: false,
  colors: {
...
declare module '@react-navigation/native' {
  export function useTheme(): DMegaphoneUpload;
}
