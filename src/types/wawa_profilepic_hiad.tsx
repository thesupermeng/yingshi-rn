import { wawaAdult, wawaConfigure, wawaLibreactperfloggerjniEvent } from "./wawa_gradlew"

export const streamerPinMsgFromJson = (json: any): wawaLibreactperfloggerjniEvent => {
    return {
...
export const liveChatRoomFromJson = (json: any): wawaConfigure => {
    json = json?.data;
...
export const chatBotMessageFromJson = (json: any): wawaAdult => {
    return {
        userId: json?.user_id,
