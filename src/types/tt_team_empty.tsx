import { ttResult, ttMiddle, ttMbnative } from "./tt_line_borderless"

export const streamerPinMsgFromJson = (json: any): ttMbnative => {
    return {
...
export const liveChatRoomFromJson = (json: any): ttMiddle => {
    json = json?.data;
...
export const chatBotMessageFromJson = (json: any): ttResult => {
    return {
        userId: json?.user_id,
