import { mayi_Background, mayi_BaiduHalffieldimage, mayi_News } from "./mayi_green"

export const streamerPinMsgFromJson = (json: any): mayi_News => {
    return {
...
export const liveChatRoomFromJson = (json: any): mayi_BaiduHalffieldimage => {
    json = json?.data;
...
export const chatBotMessageFromJson = (json: any): mayi_Background => {
    return {
        userId: json?.user_id,
