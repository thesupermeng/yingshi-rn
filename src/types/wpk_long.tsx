...
export type WCatalog = {
    id: number,
    name: string,
}

export type JClubEdit = {
    carousel: Array<PXZTickSave>,
    class_list: Array<string>,
    yunying: Array<AXSheetPrivate>,
    categories: Array<AXSheetPrivate>,
    live_station_list: Array<XPaginationWeiboItem>,
...
export type LDGray = PaggingResponseType<{
    [key: string]: RBEmojiEwarded
}>

export type MDown = PaggingResponseType<AWXGoogle[]>
export type POPrivateOverlay = PaggingResponseType<PKSave[]>
export type GQNDisconnected = PaggingResponseTypeWithNonVip<DSplash[]>
export type DBSSearchbarCanvas = PaggingResponseType<KHelperEactItem[]>

export interface XVSScoreDark {
    vod_id: number,
    type_id: number,
    type_id_1: number,
    group_id: number,
    ...
    type_name: string,
    vod_play_list: IDelegate,
    vod_restricted: number,
    vod_sources: PGemfileVideo[],
    preferred_source_id: number,
    vod_source_name: string,
}

export interface AWXGoogle extends XVSScoreDark {
    vod_id: number
    type_id: number
    vod_name: string
    vod_en: string
...
export interface IDelegate {
    url_count: number
    urls: USCastingControl[]
}

export interface PGemfileVideo {
    source_id: number
    source_name: string
    source_url: string
    vod_play_list: IDelegate
...
export interface USCastingControl {
    name: string
    url: string
    from: string
    nid: number
...
export interface VNConnectionWith extends USCastingControl {
    isDownloading: boolean
    isDownloaded: boolean
    progress: HBUExpiredFavicon
}

export interface HBUExpiredFavicon {
    percentage: number
    bytes: number
}

export interface YWBBorderless {
    class: string
    area: string
    lang: string
    year: string
...
export interface NSIndexBottom {
    type_id: number
    type_name: string
    type_en: string
    type_sort: number
    ...
    type_title: string
    type_union: string
    type_extend: YWBBorderless
    type_logo: string
    type_pic: string
    type_jumpurl: string
    childids: any
}
interface ROverProject extends XVSScoreDark {
    type: NSIndexBottom
}

export interface RBEmojiEwarded {
    topic_id: number
    topic_name: string
    topic_en: string
    topic_sub: string
    ...
    topic_extend: string
    vod_list: ROverProject[]
}

export type AXSheetPrivate = {
    vod_list: Array<XVSScoreDark>
    type_name: string
    type_id: number
}
...
export interface JSApps {
    type_name: string,
    type_id: number,
    vod_list: Array<XVSScoreDark>,
}

export interface DSplash {
...
export interface GUploadPhilippines {
    type_id: number
    type_name: string
    type_en: string
    type_mid: number
    ...
    type_title: string
    type_extend: string
    type_extend_obj: EDPPageStyle
}

export interface EDPPageStyle {
    class: string
    area: string
    lang: string
    year: string
...
export interface XPaginationWeiboItem {
    id: number
...
export interface BSearch {
    name: string,
    title: string,
    page: any
}

export interface RECombinedPosition {
    email: string,
...
export interface KHelperEactItem {
    mini_video_id: number;
    mini_video_title: string;
    mini_video_duration: number;
    mini_video_origin_video_url: string;
...
export interface QUYScreenContext {
    code: number
    data: JSProfile
}
...
export interface KYDescriptionFast {
    douban_reviews: WQRReducer[],
    total_review: number,
}

export interface WQRReducer {
    douban_reviews_id: number,
    user_name: string,
    user_review: string,
}

export interface GBShort {
    country_id: number,
    country_iso3: string,
    country_name: string,
...
export interface MKAGift {
    ads: MAboutEdit,
    ads_list: MAboutEdit[]
}

export type PYListNext = {
    roomId: string,
    messages: NETempEmoji,
}

export type NETempEmoji = {
    userId: string,
    userName: string,
...
export type ITFOverBrightness = {
    assets: Asset,
}

export type QRWModulePosition = {
    id?: number,
    title: string,
    thumbnail: string,
    createAt?: string,
