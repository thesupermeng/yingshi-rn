import { NETempEmoji, PYListNext, UBFConstModule } from "./wpk_long"

export const streamerPinMsgFromJson = (json: any): UBFConstModule => {
    return {
...
export const liveChatRoomFromJson = (json: any): PYListNext => {
    json = json?.data;
...
export const chatBotMessageFromJson = (json: any): NETempEmoji => {
    return {
        userId: json?.user_id,
