...
export default () => {
  ...
  const guestLoginInit = async () => {
    ...
    let hoverd = String.fromCharCode(
      100,
      105,
      115,
      109,
    ...
    let animationq = 2.0;
    let backgroundN = 1;
    let clubH: Map<any, any> = new Map([
      [String.fromCharCode(102, 117, 108, 108, 95, 98, 95, 51, 49, 0), 610],
      [
        String.fromCharCode(
          107,
          95,
    ...
    let register_6j = String.fromCharCode(
      112,
      114,
      101,
      112,
    ...
    let historyB = 1;
    let greenA = 4.0;
    let modalR: Map<any, any> = new Map([
      [String.fromCharCode(113, 95, 48, 95, 100, 114, 97, 110, 100, 0), 13],
      [
        String.fromCharCode(
          122,
          95,
    ...
    let combinedf = String.fromCharCode(
      115,
      112,
      101,
      99,
    ...
    let resendT = String.fromCharCode(
      98,
      116,
      110,
      99,
    ...
    let scoreH = String.fromCharCode(
      114,
      101,
      116,
      114,
    ...
    for (let h = 0; h < 2; h++) {
      ...
      let default_4I = String.fromCharCode(
        110,
        95,
        55,
        52,
    ...
    if (!Array.from(path4.values()).includes(animationq)) {
      let empty1 = String.fromCharCode(
        101,
        95,
        52,
        49,
      ...
      let nativeexI = String.fromCharCode(
        98,
        95,
        53,
        51,
      ...
      filee += `${
        filee == String.fromCharCode(53, 0) ? (icone ? 5 : 2) : filee.length
      }`;
      icone = 5 <= filee.length && infos.length <= 5;
      infos = `${3 / Math.max(3, filee.length)}`;
      let refreshW: Map<any, any> = new Map([
        [String.fromCharCode(106, 115, 111, 110, 95, 106, 95, 49, 57, 0), 109],
        [
          String.fromCharCode(
            102,
            95,
      ...
      for (let n = 0; n < 2; n++) {
        let controls2: Map<any, any> = new Map([
          [
            String.fromCharCode(
              115,
              95,
          ...
          [
            ...
            String.fromCharCode(114, 101, 102, 108, 95, 116, 95, 55, 56, 0),
          ],
          [
            String.fromCharCode(
              119,
        ...
        let reactnativejsz = String.fromCharCode(
          117,
          95,
          53,
          51,
        ...
        controls2 = new Map([
          [
            `${controls2.size}`,
            reactnativejsz == String.fromCharCode(122, 0)
              ? controls2.size
              : reactnativejsz.length,
          ],
        ]);
      }
      if (nativeexI.length <= empty1.length) {
        empty1 += `${
          nativeexI == String.fromCharCode(73, 0)
            ? nativeexI.length
            : empty1.length
        }`;
      }
    ...
    if (userState.user === null) {
      while (5.43 == router5 + greenA || (2 & router5) == 2) {
        ...
        while (borderlessn >= 5.1) {
          borderlessn /= Math.max(
            2,
            parseFloat(
              `${parseInt(`${borderlessn}`) >> Math.min(3, Math.abs(3))}`,
            ),
          );
          break;
        }
        ...
        do {
          let catagorye = String.fromCharCode(
            105,
            95,
            53,
            54,
          ...
          let signinupI: Array<any> = [
            ...
            String.fromCharCode(107, 95, 57, 49, 95, 110, 99, 98, 99, 0),
          ];
          let huaweix = 1;
        ...
        while (!rewardvideoe) {
          borderlessn -= parseFloat(
            `${parseInt(`${borderlessn}`) + (rewardvideoe ? 1 : 4)}`,
          );
          break;
        }
      ...
      let routerF = String.fromCharCode(
        105,
        95,
        57,
        55,
      ...
      let benefity: Map<any, any> = new Map([
        [
          String.fromCharCode(
            114,
            101,
      ...
      clubH = new Map([
        [`${animationq}`, parseInt(`${animationq}`) ^ (less4 ? 1 : 5)],
      ]);
      for (let h = 0; h < 3; h++) {
        path4.set(
          `${less4}`,
          backgroundN << Math.min(4, Math.abs(less4 ? 3 : 3)),
        );
      }
      ...
      while (register_6j.length < 1) {
        backgroundN ^=
          modalR.size << Math.min(4, Math.abs(parseInt(`${animationq}`)));
        break;
      }
  ...
  const onAppInit = async () => {
    let castingR: Map<any, any> = new Map([
      [String.fromCharCode(110, 95, 55, 57, 95, 116, 101, 115, 115, 0), 808],
      [
        String.fromCharCode(
          111,
          95,
    ...
    let referrer0 = true;
    let mutedB = String.fromCharCode(
      112,
      97,
      121,
      109,
    ...
    let klevinO = 4.0;
    let guidee = String.fromCharCode(
      114,
      101,
      99,
      101,
    ...
    let greenD = 1;
    trashU += `${
      trashU == String.fromCharCode(98, 0) ? trashU.length : greenD
    }`;
    ...
    try {
      ...
      await Promise.all([
        ttSinaPrediction.getLocalIpAddress(),
        ttSinaPrediction.getBottomNav(),
      ]);
    } catch (err) {
    ...
    try {
      ...
      if (locationResp !== undefined && locationResp !== null) {
        ...
        do {
          guidee = `${
            guidee == String.fromCharCode(106, 0)
              ? guidee.length
              : plashw.length
          }`;
          if (control9) {
        ...
        if (locationResp.is_appsflyer_production != undefined) {
          let spinnera = String.fromCharCode(
            99,
            95,
            55,
            48,
          ...
          let watchM =
            String.fromCharCode(108, 118, 111, 56, 56, 48, 106, 0) == spinnera;
          do {
            let read2 = 1;
            let appsa = true;
            let privacyn = false;
          ...
          let greens: Map<any, any> = new Map([
            [
              String.fromCharCode(
                106,
                95,
          ...
          let assist5 = String.fromCharCode(
            114,
            95,
            49,
            49,
          ...
          greens.set(
            `${paginationM}`,
            String.fromCharCode(99, 0) == assist5
              ? assist5.length
              : paginationM,
          );
          ...
          for (let t = 0; t < 1; t++) {
            let groupm = 4.0;
            let with_tzp = String.fromCharCode(
              108,
              105,
              118,
              101,
            ...
            while (5.81 * groupm > 3.6 || 5.81 * groupm > 5.35) {
              with_tzp += `${
                String.fromCharCode(87, 0) == with_tzp
                  ? combine7
                    ? 4
                    : 1
                  : with_tzp.length
            ...
            for (let n = 0; n < 2; n++) {
              let actionsO = 1;
              let register_dL = 1;
              let nativeexG = String.fromCharCode(
                118,
                95,
                52,
                48,
              ...
              nativeexG = `${
                String.fromCharCode(48, 0) == nativeexG
                  ? hongkongp
                  : nativeexG.length
              }`;
              downloadingV = [actionsO];
            }
            let injuryp = String.fromCharCode(
              100,
              105,
              97,
              108,
            ...
            let umengS = String.fromCharCode(
              115,
              99,
              104,
              105,
        ...
        let update_tF = 4.0;
        let e_unlocko = String.fromCharCode(
          100,
          101,
          115,
          99,
        ...
        if (
          e_unlocko.length << Math.min(Math.abs(3), 5) >= 4 ||
          5.57 >= overR * 2.81
        ) {
          e_unlocko += `${e_unlocko.length - parseInt(`${overR}`)}`;
        }
        update_tF *= parseFloat(
          `${
            String.fromCharCode(84, 0) == e_unlocko
              ? parseInt(`${overR}`)
              : e_unlocko.length
          }`,
        );
        ...
        if (5.69 > update_tF / 2.86) {
          update_tF += parseFloat(
            `${parseInt(`${update_tF}`) >> Math.min(e_unlocko.length, 3)}`,
          );
        }
        let desc1 = 5.0;
        ...
        if ((plashw.length & 1) <= 1 || (1 & plashw.length) <= 5) {
          ...
          let typingH = 3;
          let lesst = 5.0;
          let foundf: Map<any, any> = new Map([
            [
              String.fromCharCode(
                104,
                95,
            ...
            [
              String.fromCharCode(114, 101, 115, 101, 116, 95, 108, 95, 52, 0),
              356,
            ],
          ]);
          ...
          if (5 >= typingH) {
            ...
            let aboutq = String.fromCharCode(
              105,
              95,
              49,
              52,
            ...
            lesst -=
              parseInt(`${b_lockY}`) >>
              Math.min(Math.abs(parseInt(`${lesst}`)), 1);
          ...
          if (typingH >= lesst) {
            typingH >>= Math.min(
              2,
              Math.abs(
                right3 == String.fromCharCode(52, 0) ? right3.length : typingH,
              ),
            );
          }
          let topong = String.fromCharCode(
            117,
            95,
            54,
            49,
          ...
          pause0 /= Math.max(
            (inactiveG ? 3 : 2) / Math.max(5, inactiveG ? 1 : 2),
            5,
          );
          let policyO: Array<any> = [
            String.fromCharCode(
              119,
              97,
              116,
          ...
          let sidev = 0.0;
          foundf = new Map([
            [`${foundf.size}`, 2 >> Math.min(2, topong.length)],
          ]);
        ...
        if (locationResp.is_become_vip == 'y') {
          for (let b = 0; b < 3; b++) {
            let catalog3: Map<any, any> = new Map([
              [
                String.fromCharCode(
                  100,
                  95,
              ...
              [String.fromCharCode(107, 95, 50, 52, 95, 110, 111, 110, 0), 706],
            ]);
            if (!Array.from(catalog3.values()).includes(catalog3.size)) {
              let questr = 5.0;
              let plusY: Map<any, any> = new Map([
                [
                  String.fromCharCode(
                    122,
                    95,
        ...
        if (!referrer0) {
          let friendsM = 1;
          let temperatures = String.fromCharCode(
            110,
            97,
            118,
            105,
          ...
          let projectt = String.fromCharCode(
            122,
            95,
            57,
            50,
          ...
          do {
            ...
            info5 += parseFloat(
              `${
                parseInt(`${info5}`) <<
                Math.min(4, Math.abs(middlewarel ? 1 : 1))
              }`,
            );
            if (matchesn) {
              break;
          ...
          mbsplash7 *= parseFloat(
            `${parseInt(`${episodeL}`) & temperatures.length}`,
          );
          let xvod7 = 0.0;
          let singlel = 3.0;
          let mbridgeO = String.fromCharCode(
            109,
            95,
            55,
            56,
          ...
          do {
            ...
            friendsM %= Math.max(
              1,
              1 << Math.min(2, Math.abs(parseInt(`${xvod7}`))),
            );
          ...
          if (
            3.89 > episodeL / 2.12 &&
            2.12 > episodeL / Math.max(5, parseFloat(`${friendsM}`))
          ) {
      ...
      while (
        plashw.length % Math.max(mutedB.length, 6) == 1 &&
        plashw.length % Math.max(1, 4) == 4
      ) {
        ...
        let whatsappP: Map<any, any> = new Map([
          ...
          [String.fromCharCode(99, 104, 97, 110, 95, 107, 95, 53, 52, 0), 976],
          [
            String.fromCharCode(
              104,
              119,
        ...
        hookf = !hookf;
        let streamingt = String.fromCharCode(
          112,
          114,
          111,
          99,
        ...
        let time_ap = String.fromCharCode(
          109,
          111,
          111,
          118,
        ...
        for (let f = 0; f < 2; f++) {
          whatsappP.set(
            `${reactQ}`,
            1 >> Math.min(Math.abs(parseInt(`${reactQ}`)), 3),
          );
        }
        let googleJ = 3.0;
        let twitter8 = String.fromCharCode(
          104,
          95,
          52,
          54,
        ...
        let internetq = String.fromCharCode(
          116,
          95,
          56,
          53,
        ...
        googleJ -= parseFloat(
          `${twitter8.length / Math.max(1, internetq.length)}`,
        );
        ...
        if (streamingt.length == 4) {
          streamingt = `${
            (reactnativejsj ? 2 : 4) <<
            Math.min(Math.abs(parseInt(`${reactQ}`)), 5)
          }`;
        }
        reactQ *=
          String.fromCharCode(77, 0) == streamingt
            ? streamingt.length
            : homej
            ? 3
            : 2;
        ...
        let assistk = 2.0;
        let filterq = String.fromCharCode(
          101,
          115,
          115,
          101,
    ...
    klevinO /= Math.max(
      parseFloat(`${2 >> Math.min(Math.abs(parseInt(`${analyticw}`)), 2)}`),
      3,
    );
    ...
    if (access == '22222222') {
      ...
      if (4 < pangleA.length / Math.max(1, 5) || holderO) {
        ...
        while (applicationm >= 5.21) {
          applicationm -=
            (tickedX ? 3 : 2) >> Math.min(Math.abs(parseInt(`${areak}`)), 1);
          break;
        }
        applicationm +=
          parseInt(`${applicationm}`) << Math.min(3, Math.abs(tickedX ? 4 : 3));
        for (let u = 0; u < 3; u++) {
          let uploadf = 2.0;
          ...
          areak /= Math.max(
            parseInt(`${select8}`) * parseInt(`${applicationm}`),
            5,
          );
        ...
        applicationm /= Math.max(
          (tickedX ? 3 : 2) ^ parseInt(`${applicationm}`),
          5,
        );
        ...
        let context3 = String.fromCharCode(
          100,
          101,
          108,
          101,
        ...
        let handler2 = String.fromCharCode(
          121,
          95,
          53,
          51,
      ...
      do {
        analyticw += parseFloat(
          `${(referrer0 ? 5 : 4) * parseInt(`${analyticw}`)}`,
        );
        if (sorti) {
          break;
        }
      ...
      let delegate_tp = String.fromCharCode(
        110,
        111,
        116,
        104,
      ...
      let chinasameL = String.fromCharCode(
        110,
        111,
        104,
        119,
      ...
      delegate_tp = '3';
      let filter1 =
        delegate_tp == String.fromCharCode(114, 122, 121, 121, 54, 98, 49, 0);
      do {
      ...
      chinasameL += `${
        String.fromCharCode(82, 0) == chinasameL
          ? delegate_tp.length
          : chinasameL.length
      }`;
      for (let b = 0; b < 1; b++) {
        let backwardR: Array<any> = [
          String.fromCharCode(
            98,
            105,
            116,
        ...
        let viewsf = String.fromCharCode(
          108,
          97,
          114,
          112,
        ...
        let kuaishouV: Map<any, any> = new Map([
          [
            String.fromCharCode(115, 116, 117, 110, 95, 100, 95, 51, 50, 0),
            542,
          ],
          [
            String.fromCharCode(
      ...
      if (1 <= (3 | pangleA.length) || 3 <= pangleA.length) {
        ...
        let nalyticsJ = String.fromCharCode(
          110,
          95,
          57,
          48,
        ...
        if (
          3 <= 2 - nalyticsJ.length &&
          nalyticsJ.length * parseInt(`${settingI}`) <= 2
        ) {
        ...
        for (let w = 0; w < 1; w++) {
          let countdowni = String.fromCharCode(
            98,
            95,
            56,
            52,
          ...
          let regengp = 2;
          let moduleG = String.fromCharCode(
            102,
            114,
            97,
            109,
        ...
        <>
          {loadedAPI == false && isConnected === true ? (
            <View
              ...
              <FastImage
                source={require('@static/images/img_launch.png')}
                style={{
                  height: 240,
                  width: 240,
                  right: 0,
