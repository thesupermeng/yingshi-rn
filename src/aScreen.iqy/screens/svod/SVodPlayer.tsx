...
import PlayIcon from '../../assets/images/blackPlay.svg';
...
import FastImage from './SVodImage';
...
const videoBufferGif = require('../../assets/images/videoBufferLoading.gif')
...
function SVodPlayer({
  ...
  const iconTimer = useRef<NodeJS.Timeout>();
  ...
  const handlePlayPause = () => {
    if (iconTimer.current != undefined) {
...
export default memo(SVodPlayer);
