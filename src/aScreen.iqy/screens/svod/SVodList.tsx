...
import ShortVod from '../../../components/videoPlayer/WatchAnytime/shortVod';
import { MiniVideo } from '@type/ajaxTypes';
import SVodImage from './SVodImage';
...
import SVodInfoView from './SVodInfo';
import SVodOptionsView from './SVodOptions';
import SVodItem from './SVodItem';
import { svodAvatars } from './SVodAvatar';
...
const homeLoadingGif = require('../../assets/images/home-loading.gif');
const loadingSpinnerGif = require('../../assets/images/loading-spinner.gif');
...
export default forwardRef<MiniVodRef, Props>(
  (
      ...
      ({ item, index }: { item: MiniVideo; index: number }) => {
        ...
        return (
          <View style={{ height: displayHeight ? displayHeight : 0 }}>
            ...
            <SVodInfoView vod={item}/>
            <SVodOptionsView vod={item} avatar={svodAvatars[index%svodAvatars.length]}/>
          </View>
        )
      },
      [
    ...
    return (
      <>
        <View style={{ width: "100%", height: "100%"}} onLayout={onLayoutRender}>
          {isInitFetching ? (
