...
import ScreenContainer from "../container/ww_collection";
import TitleWithBackButtonHeader from "../header/ww_react_predictionwin_header";
import { useTheme } from "@react-navigation/native";
import { StyleSheet, Text, View } from "react-native";
import { VipNav } from "../tabNavigate/ww_notificationfillempty_ball_view";
import { useEffect, useState } from "react";
import { VipHistoryList } from "./ww_orange_iconnewsshare";
import { VipInviteHistory } from "./ww_codegen";
import { SHOW_ZF_CONST } from "@utility/ww_icon";
...
export const VipDetails = ({
  ...
  let navOptions = [
    { id: 0, name: "邀请记录" },
    { id: 1, name: wwAbidetect.instance.showBecomeVip ? "VIP记录" : "购买记录" },
  ];
