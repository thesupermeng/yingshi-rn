...
import { Position, useCPanGestureHook } from './xsb_success';


export type UWPScore = {
    start?: Position,
    previous?: Position,
    current?: Position,
    different?: Position,
...
type YJProjectSend = {
    ...
    onStart?: (context?: UWPScore) => void,
    onUpdate?: (context?: UWPScore) => void,
    onEnd?: (context?: UWPScore) => void,
