...
import { Position, useCPanGestureHook } from './tt_pause';


export type ttInterstitialSell = {
    start?: Position,
    previous?: Position,
    current?: Position,
    different?: Position,
...
type ttMbsplash = {
    ...
    onStart?: (context?: ttInterstitialSell) => void,
    onUpdate?: (context?: ttInterstitialSell) => void,
    onEnd?: (context?: ttInterstitialSell) => void,
