...
import Moon from '@static/images/newarchdefaultsBing.svg';
import Sun from '@static/images/miniTelemetryUnread.svg';
import MutedVolume from '@static/images/langkeyEmoji.svg';
import Volume from '@static/images/combinedLangkeyLibfb.svg';
...
export default ({ percent, icon }: yys_ConfigureUimanager) => {
  return (
