...
import BrightnessGestureIcon from '@static/images/tumbnailStreamingTumbnail.svg';
import VolumeGestureIcon from '@static/images/fastforwardPromotion.svg';
import ProgressGestureIcon from '@static/images/hoverRouter.svg';
import { useAppDispatch } from '@hooks/kg_index';
import { hideVodGestureGuide } from '@redux/actions/h_nalytics_typing';
