...
import Moon from '@static/images/sportLaunchWatch.svg';
import Sun from '@static/images/moduleFrame_jsActive.svg';
import MutedVolume from '@static/images/unselectedDark.svg';
import Volume from '@static/images/dangerThumbnailMode.svg';
...
export default ({ percent, icon }: XFillButton) => {
  return (
