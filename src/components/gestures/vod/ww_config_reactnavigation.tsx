...
import Moon from '@static/images/filedSelectedAndroid.svg';
import Sun from '@static/images/plashProfileframeTyping.svg';
import MutedVolume from '@static/images/uploadHumidityImagenetworkerr.svg';
import Volume from '@static/images/short_9iYing.svg';
...
export default ({ percent, icon }: wwIndexDice) => {
  return (
