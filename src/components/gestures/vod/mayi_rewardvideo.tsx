...
import Moon from '@static/images/iconstarCatagory.svg';
import Sun from '@static/images/phoneInviteLibhermes.svg';
import MutedVolume from '@static/images/taiwanScore.svg';
import Volume from '@static/images/iconarrowrightorangeReminderPosition.svg';
...
export default ({ percent, icon }: mayi_GoogleViews) => {
  return (
