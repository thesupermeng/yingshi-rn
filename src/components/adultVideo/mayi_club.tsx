...
import { acceptOverEighteen, disableAdultMode, disableWatchAnytimeAdultMode, enableAdultMode, enableWatchAnytimeAdultMode, hideAdultModeVip, showAdultModeDisclaimer, showAdultModeVip } from "@redux/actions/mayi_iconorientation_chatroombackground";
import AdultSwitchON from '@static/images/descCodegenWhatsapp.svg'
import AdultSwitchOFF from '@static/images/editMountingResend.svg'
...
const AdultModeSwitch = ({switchStyle}: mayi_GoogleViews) => {
