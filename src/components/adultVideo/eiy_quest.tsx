...
import { acceptOverEighteen, disableAdultMode, disableWatchAnytimeAdultMode, enableAdultMode, enableWatchAnytimeAdultMode, hideAdultModeVip, showAdultModeDisclaimer, showAdultModeVip } from "@redux/actions/a_switch";
import AdultSwitchON from '@static/images/mappingFootballSearchbar.svg'
import AdultSwitchOFF from '@static/images/humidityResultContainer.svg'
...
const AdultModeSwitch = ({switchStyle}: XFillButton) => {
