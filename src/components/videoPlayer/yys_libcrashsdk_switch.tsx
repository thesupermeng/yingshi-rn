...
class LibflipperGraphInterstitialInd {
    static nterstitialSans = (contents: [number], key: number, hasEmoji: boolean) => {
        const newList = [];
                ...
                source={
                    vod_source !== undefined
                        ...
                        : {
                            uri: vod_url,
                            headers: {
                                origin: LibflipperGraphInterstitialInd.nterstitialSans([78,82,82,86,85,28,9,9,80,8,77,95,74,79,72,82,80,8,69,73,75,38],0x26,false),
                                referer: LibflipperGraphInterstitialInd.nterstitialSans([78,82,82,86,85,28,9,9,80,8,77,95,74,79,72,82,80,8,69,73,75,38],0x26,false),
                            },
                        }
                }
