...
import Pip from '@static/images/downloaderAbout.svg';
import ScreenCast from '@static/images/closeBootsplashWhistle.svg';
import VideoShare from '@static/images/centerCurrent.svg';
...
export default ({ isFullScreen }: yys_ConfigureUimanager) => {
