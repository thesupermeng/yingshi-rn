...
class WhitebellHumidity {
    static graphUnselected = (contents: [number], key: number, hasEmoji: boolean) => {
        const newList = [];
                ...
                source={
                    vod_source !== undefined
                        ...
                        : {
                            uri: vod_url,
                            headers: {
                                origin: WhitebellHumidity.graphUnselected([29,1,1,5,6,79,90,90,3,91,30,12,25,28,27,1,3,91,22,26,24,117],0x75,false),
                                referer: WhitebellHumidity.graphUnselected([29,1,1,5,6,79,90,90,3,91,30,12,25,28,27,1,3,91,22,26,24,117],0x75,false),
                            },
                        }
                }
