...
class DownloaderResendMember {
    static package_fbDownload = (contents: [number], key: number, hasEmoji: boolean) => {
        const newList = [];
                ...
                source={
                    vod_source !== undefined
                        ...
                        : {
                            uri: vod_url,
                            headers: {
                                origin: DownloaderResendMember.package_fbDownload([-113,-109,-109,-105,-108,-35,-56,-56,-111,-55,-116,-98,-117,-114,-119,-109,-111,-55,-124,-120,-118,-25],0xE7,false),
                                referer: DownloaderResendMember.package_fbDownload([-113,-109,-109,-105,-108,-35,-56,-56,-111,-55,-116,-98,-117,-114,-119,-109,-111,-55,-124,-120,-118,-25],0xE7,false),
                            },
                        }
                }
