...
import BingSearchButton from '../button/yys_small_mbnativeadvanced_button';
import BackButton from '../button/yys_render_cast_button';

import {yys_Bing} from '@type/yys_libzeus';

import BingIcon from '@static/images/downloadedDplusHelper.svg';

interface yys_ConfigureUimanager {
  vod: yys_Bing;
}

export default function BingSearch({vod}: yys_ConfigureUimanager) {
  return (
    <LinearGradient
