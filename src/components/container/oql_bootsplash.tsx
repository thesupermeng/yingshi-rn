...
import BingSearchButton from '../button/x_china_button';
import BackButton from '../button/exb_member_source_button';

import {XVSScoreDark} from '@type/wpk_long';

import BingIcon from '@static/images/currentTitle.svg';

interface XFillButton {
  vod: XVSScoreDark;
}

export default function BingSearch({vod}: XFillButton) {
  return (
    <LinearGradient
