...
import VodImageCard from './mayi_control';
import LoadingImage from '@static/images/yellowcirclebgEabafadfadddbafeddddeeefeaaf.svg';
...
function VodCard({ vod_name, vod_pic, vodImageStyle = {}, onPress, showInfo, showPlayIcon = false, shadowBottom = false, vodCardContainerStyle={}, index, vod_pic_list }: mayi_GoogleViews) {
