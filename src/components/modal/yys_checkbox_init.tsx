...
import EighteenPlusIcon from '@static/images/libreactnativeblobUnlock.svg';
...
export default function EighteenPlusOverlay({ handleAccept, handleReject , isRadius=false }: yys_ConfigureUimanager) {
