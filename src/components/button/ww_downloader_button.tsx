...
import { useAppSelector, useAppDispatch } from '@hooks/ww_catagory_neon';
import { wwEighteenShirt } from '@redux/ww_small';
import { togglePlaylistFavorites } from '@redux/actions/ww_floater';
...
export default function FavoritePlaylistButton({ leftIcon, buttonStyle, playlist }: wwIndexDice) {
    const { colors, textVariants, spacing, icons } = useTheme();
    const favoritePlaylistSelector = useAppSelector(({ vodPlaylistReducer }: wwEighteenShirt) => vodPlaylistReducer)
