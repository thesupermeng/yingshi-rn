...
interface mayi_GoogleViews {
  recommendationList: Array<mayi_LibswresampleModal>;
}

type mayi_Rocket = {
  item: mayi_LibswresampleModal;
  index: number;
};

export default function RecommendationList({recommendationList}: mayi_GoogleViews) {
