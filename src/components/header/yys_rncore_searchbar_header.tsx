...
import { yys_ServiceBridge } from '@type/yys_settings';

interface yys_ConfigureUimanager {
    route: '视频收藏' | '播单收藏' | '合集收藏',
    navigator: NativeStackNavigationProp<yys_ServiceBridge,  '视频收藏' | '播单收藏' | '合集收藏', any>
}

export default function CollectionHeader({ route, navigator }: yys_ConfigureUimanager) {
