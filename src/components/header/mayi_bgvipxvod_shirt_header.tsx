...
import { mayi_Collection } from '@type/mayi_video_binddatas';

interface mayi_GoogleViews {
    route: '视频收藏' | '播单收藏' | '合集收藏',
    navigator: NativeStackNavigationProp<mayi_Collection,  '视频收藏' | '播单收藏' | '合集收藏', any>
}

export default function CollectionHeader({ route, navigator }: mayi_GoogleViews) {
