...
import { wawaDelegate } from '@type/wawa_iconnewchat';

interface wawaAwayShow {
    route: '视频收藏' | '播单收藏' | '合集收藏',
    navigator: NativeStackNavigationProp<wawaDelegate,  '视频收藏' | '播单收藏' | '合集收藏', any>
}

export default function CollectionHeader({ route, navigator }: wawaAwayShow) {
