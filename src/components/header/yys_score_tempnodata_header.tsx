...
import { yysPredictionbanner } from '@type';

interface yysIconarrowrightorangeStation {
    route: '视频收藏' | '播单收藏' | '合集收藏',
    navigator: NativeStackNavigationProp<yysPredictionbanner, '视频收藏' | '播单收藏' | '合集收藏', any>
}

export default function CollectionHeader({ route, navigator }: yysIconarrowrightorangeStation) {
