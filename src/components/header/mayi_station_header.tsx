...
import { mayi_Collection, RootStackScreenProps } from "@type/mayi_video_binddatas";
import {
    showLoginAction,
...
interface mayi_GoogleViews {
    ...
    destination: keyof mayi_Collection,
}



export default function PrivacyBackButtonHeader({ title, headerStyle, right, destination }: mayi_GoogleViews) {
