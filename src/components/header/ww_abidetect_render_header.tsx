...
import { wwIconsubssuccess } from '@type/ww_tempnodatagif_description';

interface wwIndexDice {
    route: '视频收藏' | '播单收藏' | '合集收藏',
    navigator: NativeStackNavigationProp<wwIconsubssuccess,  '视频收藏' | '播单收藏' | '合集收藏', any>
}

export default function CollectionHeader({ route, navigator }: wwIndexDice) {
