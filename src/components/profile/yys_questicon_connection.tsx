...
type yysLeagueBasketballmatchdetailbg = {
    data: yysPlayPenaltygoal[],
    dataSelected?: yysPlayPenaltygoal,
    onSelectCountryPhone: (data: yysPlayPenaltygoal) => void,
}
export const CountryPhoneList = ({
    data,
    dataSelected,
    onSelectCountryPhone: onSelectPhoneCode,
}: yysLeagueBasketballmatchdetailbg) => {
