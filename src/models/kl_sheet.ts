export class KWConstants {
    ...
    public static fromJson = (json: any): KWConstants => {
        return new KWConstants({
    ...
    public static isGuest = (user?: KWConstants | null): boolean => {
        if (user === null || user === undefined) return true;

        return user.userEmail === '' && user.userPhoneNumber === '';
    }

    public static isLogin = (user?: KWConstants | null): boolean => {
        if (user === null || user === undefined) return false;

        return user.userEmail !== '' || user.userPhoneNumber !== '';
    }

    public static isVip = (user?: KWConstants | null): boolean => {
        if (user === null || user === undefined) return false;
