...
export default function FootballIconComponent({ showLessIcon = false }: yysIconarrowrightorangeStation) {
            ...
            {!showLessIcon ? (
                <View style={{ marginLeft: "auto", marginRight: "auto", width: '90%' }}>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <View style={styles.imageDiv}>
                            <Image style={styles.imageStyle} source={yysRenderNewarchdefaults} />
