...
import Chart from '../statisticCharts/mayi_full_player';
...
export default function AreaChart({ liveRoomUpdate, chartCallback }: mayi_GoogleViews) {
        ...
        <View style={styles.container}>
            <View style={styles.rowContent}>
                ...
                <View
                    ...
                    {/* mayi_awayteamfield mayi_Combine */}
            ...
            <View style={styles.rowContent}>
                ...
                <View style={[styles.rightContent, { height: iconHeight }]}>
                    {/* mayi_ProjectLibjsijniprofiler mayi_Combine */}
