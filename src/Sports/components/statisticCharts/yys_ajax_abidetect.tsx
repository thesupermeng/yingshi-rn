...
export default function AreaChart({ liveRoomUpdate, chartCallback }: yys_ConfigureUimanager) {
        ...
        <View style={styles.container}>
            <View style={styles.rowContent}>
                ...
                <View
                    ...
                    {/* yys_dycreator yys_Libjsinspector */}
            ...
            <View style={styles.rowContent}>
                ...
                <View style={[styles.rightContent, { height: iconHeight }]}>
                    {/* yys_SecurityConstants yys_Libjsinspector */}
