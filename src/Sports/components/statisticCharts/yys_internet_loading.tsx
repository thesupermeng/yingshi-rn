...
import Chart from '../statisticCharts/yys_borderless';
...
export default function AreaChart({ liveRoomUpdate, chartCallback }: yysIconarrowrightorangeStation) {
        ...
        <View style={styles.container}>
            <View style={styles.rowContent}>
                ...
                <View
                    ...
                    {/* yys_calendar yysControlInformation */}
            ...
            <View style={styles.rowContent}>
                ...
                <View style={[styles.rightContent, { height: iconHeight }]}>
                    {/* yysTyping yysControlInformation */}
