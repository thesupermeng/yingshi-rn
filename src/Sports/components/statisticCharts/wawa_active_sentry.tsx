...
import Chart from '../statisticCharts/wawa_defaultfootballbg_node';
...
import DefaultTeamIcon from '../wawa_eighteen_arrowup';
import CanvasIncident from './wawa_fast';
...
export default function AreaChart({ liveRoomUpdate, chartCallback }: wawaAwayShow) {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.rowContent}>
                ...
                <View style={[styles.rightContent, { height: iconHeight }]}>
                    {/* wawaTextGradlew wawaUpdatesString */}
