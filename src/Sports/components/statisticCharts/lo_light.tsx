...
import Chart from '../statisticCharts/w_loading';
...
import CanvasIncident from './li_form';
...
export default function AreaChart({ liveRoomUpdate, chartCallback }: XFillButton) {
