...
import { Position, useCPanGestureHook } from './ww_textinput';


export type wwLibjsijniprofilerPangle = {
    start?: Position,
    previous?: Position,
    current?: Position,
    different?: Position,
...
type wwSell = {
    ...
    onStart?: (context?: wwLibjsijniprofilerPangle) => void,
    onUpdate?: (context?: wwLibjsijniprofilerPangle) => void,
    onEnd?: (context?: wwLibjsijniprofilerPangle) => void,
