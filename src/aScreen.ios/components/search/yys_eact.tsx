...
interface yysIconarrowrightorangeStation {
  recommendationList: Array<yysFullLibcrashsdk>;
}

type yysLauncherHomeloading = {
  item: yysFullLibcrashsdk;
  index: number;
};

export default function RecommendationList({ recommendationList }: yysIconarrowrightorangeStation) {
