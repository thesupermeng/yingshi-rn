...
interface yys_ConfigureUimanager {
  recommendationList: Array<yys_ActivityTumbnail>;
}

type yys_FoundCanvas = {
  item: yys_ActivityTumbnail;
  index: number;
};

export default function RecommendationList({recommendationList}: yys_ConfigureUimanager) {
