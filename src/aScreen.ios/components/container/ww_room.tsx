...
import BingSearchButton from '../button/ww_filled_bell_button';
import BackButton from '../button/ww_page_button';

import {wwControl} from '@type/ww_dycreator_result';

import BingIcon from '@static/images/overCornerWhatsapp.svg';

interface wwIndexDice {
  vod: wwControl;
}

export default function BingSearch({vod}: wwIndexDice) {
  return (
    <LinearGradient
