...
import BingSearchButton from '../button/mayi_with_defaultlogo_button';
import BackButton from '../button/mayi_issub_button';

import {mayi_EmptyGradle} from '@type/mayi_green';

import BingIcon from '@static/images/videobufferloadingPathLangkey.svg';

interface mayi_GoogleViews {
  vod: mayi_EmptyGradle;
}

export default function BingSearch({vod}: mayi_GoogleViews) {
  return (
    <LinearGradient
