...
import ScreenContainer from "../container/mayi_save";
import TitleWithBackButtonHeader from "../header/mayi_predictiondefault_header";
import { useTheme } from "@react-navigation/native";
import { StyleSheet, Text, View } from "react-native";
import { VipNav } from "../tabNavigate/mayi_eact_view";
import { useEffect, useState } from "react";
import { VipHistoryList } from "./mayi_iconsetting";
import { VipInviteHistory } from "./mayi_select_redirect";
import { SHOW_ZF_CONST } from "@utility/mayi_middleware_apps";
...
export const VipDetails = ({
  ...
  let navOptions = [
    { id: 0, name: "邀请记录" },
    { id: 1, name:  mayi_Librrc.instance.showBecomeVip ? "VIP记录" : "购买记录" },
  ];
