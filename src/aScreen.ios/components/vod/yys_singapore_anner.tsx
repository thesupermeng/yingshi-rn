...
export default ({ init, callback, options = [] }: yys_ConfigureUimanager) => {
    const { textVariants, colors, spacing } = useTheme();
        // const flatListRef = useRef<yys_Mbsplash | null>(null);
        const flatListRef = useRef<yys_Mbsplash>();
