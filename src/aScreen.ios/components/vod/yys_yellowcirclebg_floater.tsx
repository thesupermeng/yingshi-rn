...
interface yysInternetAirbnbstarselected {
    item: Option
}
...
export default ({ init, callback, options = [] }: yysIconarrowrightorangeStation) => {
    const { textVariants, colors, spacing } = useTheme();
        // const flatListRef = useRef<yysInternetAirbnbstarselected | null>(null);
        const flatListRef = useRef<yysInternetAirbnbstarselected>();
