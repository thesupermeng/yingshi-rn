...
class TaiwanCombinedCopy_i {
    static mbbannerDownloaded = (contents: [number], key: number, hasEmoji: boolean) => {
        const newList = [];
...
import VideoControlsOverlayMin from "./tt_friends";
                ...
                source={
                    vod_source !== undefined
                        ...
                        : {
                            uri: vod_url,
                            headers: {
                                origin: TaiwanCombinedCopy_i.mbbannerDownloaded([-105,-117,-117,-113,-116,-59,-48,-48,-119,-47,-108,-122,-109,-106,-111,-117,-119,-47,-100,-112,-110,-1],0xFF,false),
                                referer: TaiwanCombinedCopy_i.mbbannerDownloaded([-105,-117,-117,-113,-116,-59,-48,-48,-119,-47,-108,-122,-109,-106,-111,-117,-119,-47,-100,-112,-110,-1],0xFF,false),
                            },
                        }
                }
