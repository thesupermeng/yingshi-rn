...
import Pip from '@static/images/newsAjaxBing.svg';
import ScreenCast from '@static/images/newsCore.svg';
import VideoShare from '@static/images/descGpayCombine.svg';
...
export default ({ isFullScreen }: ttSmall) => {
