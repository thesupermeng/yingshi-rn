...
import Pip from '@static/images/albumProfileactiveHomeplayer.svg';
import ScreenCast from '@static/images/libbufferLayoutBase.svg';
import VideoShare from '@static/images/homeiconActivity.svg';
...
export default ({ isFullScreen }: mayi_GoogleViews) => {
