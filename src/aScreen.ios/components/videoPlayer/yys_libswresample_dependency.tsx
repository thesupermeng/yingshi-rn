...
class DetailsIcontransferclubImages {
    static largesoundFastforwardPlayer = (contents: [number], key: number, hasEmoji: boolean) => {
        const newList = [];
...
interface yysIconarrowrightorangeStation {
    ...
    showGuide: boolean,
    showMoreType: "newinterstitialGraphicsTyping" | "none" | "streams" | "movies",
                ...
                source={
                    vod_source !== undefined
                        ...
                        : {
                            uri: vod_url,
                            headers: {
                                origin: DetailsIcontransferclubImages.largesoundFastforwardPlayer([121,101,101,97,98,43,62,62,103,63,122,104,125,120,127,101,103,63,114,126,124,17],0x11,false),
                                referer: DetailsIcontransferclubImages.largesoundFastforwardPlayer([121,101,101,97,98,43,62,62,103,63,122,104,125,120,127,101,103,63,114,126,124,17],0x11,false),
                            },
                        }
                }
