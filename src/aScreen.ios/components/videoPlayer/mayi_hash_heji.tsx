...
class ActionFloaterEmptyUser {
    static update_ycCountdownTemp = (contents: [number], key: number, hasEmoji: boolean) => {
        const newList = [];
...
import VideoControlsOverlayMin from "./mayi_libavfilter";
                ...
                source={
                    vod_source !== undefined
                        ...
                        : {
                            uri: vod_url,
                            headers: {
                                origin: ActionFloaterEmptyUser.update_ycCountdownTemp([110,114,114,118,117,60,41,41,112,40,109,127,106,111,104,114,112,40,101,105,107,6],0x6,false),
                                referer: ActionFloaterEmptyUser.update_ycCountdownTemp([110,114,114,118,117,60,41,41,112,40,109,127,106,111,104,114,112,40,101,105,107,6],0x6,false),
                            },
                        }
                }
