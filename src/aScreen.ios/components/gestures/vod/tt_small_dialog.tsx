...
import Moon from '@static/images/foundSpinner.svg';
import Sun from '@static/images/rewindLoginModels.svg';
import MutedVolume from '@static/images/catagoryShort_jPage.svg';
import Volume from '@static/images/downloadVideojs.svg';
...
export default ({ percent, icon }: ttSmall) => {
  return (
