...
function addVideoToDownload(vod: Vod, vodSourceId: number, vodUrlNid: number, vodIsAdult?: boolean): DownloadVideoActionType {
  return {
...
function updateVideoDownload(vod: Vod, vodSourceId: number, vodUrlNid: number, optional: OptionalUpdateFields): DownloadVideoActionType {
  return {
...
function startVideoDownload(vod: Vod, vodSourceId: number, vodUrlNid: number): DownloadVideoActionType {
  return {
...
function endVideoDownload(vod: Vod, vodSourceId: number, vodUrlNid: number): DownloadVideoActionType {
  return {
...
export function addDownloadToQueue(vod: Vod, vodSourceId: number, vodUrlNid: number): DownloadVideoActionType {
  return {
...
export function removeDownloadFromQueue(vod: Vod, vodSourceId: number, vodUrlNid: number): DownloadVideoActionType {
  return {
...
export function removeVideoFromDownload(vod: Vod, vodSourceId: number, vodUrlNid: number): DownloadVideoActionType {
  return {
...
export function removeVodFromDownload(vod: Vod, vodSourceId: number, vodUrlNid: number): DownloadVideoActionType {
  return {
...
function pauseVideoDownload(vod: Vod, vodSourceId: number, vodUrlNid: number): DownloadVideoActionType {
  return {
...
function updateVodDetails(vod: Vod): DownloadVideoActionType {
  return {
