import { HIDE_VOD_PLAYER_GUIDE, ACCEPT_PRIVACY_POLICY, HANDLE_APP_ORIENTATION, HANDLE_DEVICES_ORIENTATION, LOCK_ORIENTATION, UPDATE_NETWORK_INFO } from "@utility/ww_icon"
import { wwZoomInvite, wwStoreAnalytic } from "@type/ww_bang"
import { wwFirebase, wwControl } from "@type/ww_dycreator_result"
import Orientation, { OrientationType } from "react-native-orientation-locker";

export interface wwShielddoneAlbum {
...
const initialState: wwShielddoneAlbum = {
...
export function settingsReducer(state = initialState, action: wwStoreAnalytic) {
    switch (action.type) {
