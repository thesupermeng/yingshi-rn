...
export type yys_HejiCricket = {
  user: yys_RelatedTooltips | null,
}

const initialState: yys_HejiCricket = {
  user: null,
}

export function userReducer(state = initialState, action: yys_Libswscale): yys_HejiCricket {
  switch (action.type) {
    ...
    case 'update_user_auth':
      const newUserDetails = yys_RelatedTooltips.fromJson({
