import { HIDE_VOD_PLAYER_GUIDE, ACCEPT_PRIVACY_POLICY, HANDLE_APP_ORIENTATION, HANDLE_DEVICES_ORIENTATION, LOCK_ORIENTATION, UPDATE_NETWORK_INFO } from "@utility/tt_trophy_cross"
import { ttBodanMacau, ttIncidentShrink } from "@type/tt_history_upload"
import { ttSport, ttAppsOther } from "@type/tt_line_borderless"
import Orientation, { OrientationType } from "react-native-orientation-locker";

export interface ttBaiduNewinterstitial {
...
const initialState: ttBaiduNewinterstitial = {
...
export function settingsReducer(state = initialState, action: ttIncidentShrink) {
    switch (action.type) {
