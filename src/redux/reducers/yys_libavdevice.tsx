import { HIDE_VOD_PLAYER_GUIDE, ACCEPT_PRIVACY_POLICY, HANDLE_APP_ORIENTATION, HANDLE_DEVICES_ORIENTATION, LOCK_ORIENTATION, UPDATE_NETWORK_INFO } from "@utility/yys_ajax_switch"
import { yys_MiniOverlay, yys_RegisterUpgrade } from "@type/yys_basketball"
import { yys_BrightnessCopy, yys_Bing } from "@type/yys_libzeus"
import Orientation, { OrientationType } from "react-native-orientation-locker";

export interface yys_Videocommon {
...
const initialState: yys_Videocommon = {
...
export function settingsReducer(state = initialState, action: yys_RegisterUpgrade) {
    switch (action.type) {
