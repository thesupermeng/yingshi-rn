import { HIDE_VOD_PLAYER_GUIDE, ACCEPT_PRIVACY_POLICY, HANDLE_APP_ORIENTATION, HANDLE_DEVICES_ORIENTATION, LOCK_ORIENTATION, UPDATE_NETWORK_INFO } from "@utility/mayi_middleware_apps"
import { mayi_MbsplashStats, mayi_StylesList } from "@type/mayi_analytic_half"
import { mayi_Runtime, mayi_EmptyGradle } from "@type/mayi_green"
import Orientation, { OrientationType } from "react-native-orientation-locker";

export interface mayi_InjuryNewinterstitial {
...
const initialState: mayi_InjuryNewinterstitial = {
...
export function settingsReducer(state = initialState, action: mayi_StylesList) {
    switch (action.type) {
