...
type wwReactnativeultimatelistview = {
  type: string;
  payload: any;
}

export type wwVertical = {
  user: wwBodan | null,
}

const initialState: wwVertical = {
  user: null,
}

export function userReducer(state = initialState, action: wwReactnativeultimatelistview): wwVertical {
  switch (action.type) {
    ...
    case 'update_user_auth':
      const newUserDetails = wwBodan.fromJson({
