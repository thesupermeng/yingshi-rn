...
type KNConstantsEvent = {
  type: string;
  payload: any;
}

export type HDTGesturesList = {
  user: KWConstants | null,
}

const initialState: HDTGesturesList = {
  user: null,
}

export function userReducer(state = initialState, action: KNConstantsEvent): HDTGesturesList {
  switch (action.type) {
    ...
    case 'update_user_auth':
      const newUserDetails = KWConstants.fromJson({
