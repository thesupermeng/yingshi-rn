import { HIDE_VOD_PLAYER_GUIDE, ACCEPT_PRIVACY_POLICY, HANDLE_APP_ORIENTATION, HANDLE_DEVICES_ORIENTATION, LOCK_ORIENTATION, UPDATE_NETWORK_INFO } from "@utility/n_subs_interstitial"
import { YJHMegaphone, LGRefreshRedirect } from "@type/qkf_bell"
import { RBEmojiEwarded, XVSScoreDark } from "@type/wpk_long"
import Orientation, { OrientationType } from "react-native-orientation-locker";

export interface GBYMiniCanvas {
...
const initialState: GBYMiniCanvas = {
...
export function settingsReducer(state = initialState, action: LGRefreshRedirect) {
    switch (action.type) {
