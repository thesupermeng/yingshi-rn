        ...
        <ScrollView>
          ...
          <Text style={textVariants.body}>
            {`《${APP_NAME_CONST2}隐私协议》目录\n` +
              ...
              `十二、争议解决\n\n` +
              `一、引言\n\n` +
              `1. 本《${APP_NAME_CONST2}隐私协议》（以下称“本隐私协议”）适用于${APP_NAME_CONST2}的全部产品和服务，包括iOS端应用程序、安卓端应用程序、网页端等全部终端客户端。\n` +
              ...
              `十、联系我们\n\n` +
              `1. 如您对本《${APP_NAME_CONST2}隐私协议》的内容或使用我们的服务时遇到的与隐私保护相关的事宜有任何疑问或进行咨询或投诉时，您均可以通过如下任一方式与我们取得联系：\n` +
