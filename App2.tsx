...
const App: () => React$Node = () => {
  ...
  const adjustConfig = new AdjustConfig("9cnz9ep9bhmo", AdjustConfig.EnvironmentProduction);
  ...
  function _onPress_trackSimpleEvent2() {
  ...
  return (
    <>
      ...
      <TouchableHighlight
          ...
          <Text>Track Simple Install</Text>
        </TouchableHighlight>
        <TouchableHighlight
          style={styles.button}
          onPress={_onPress_trackSimpleEvent2}>
          <Text>Track Simple Open</Text>
        </TouchableHighlight>
        <TouchableHighlight
          style={styles.button}
